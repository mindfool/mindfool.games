...
import { MindfulEating } from '../src/components/MindfulEating';
...
export default function MindfulEatingScreen() {
  ...
  return (
    <LinearGradient
      colors={['#FEF3C7', '#FFFBEB', COLORS.backgroundLight]}
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Slow down and truly savor each bite</Text>
          </View>

          <MindfulEating duration={1200} onComplete={handleComplete} />
        </View>
      </SafeAreaView>
    </LinearGradient>
  );
